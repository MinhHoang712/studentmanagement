...
from studentmanage.models import CustomUser, Staffs, Courses, Subjects, Students, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult
...
def staff_profile_update(request):
    if request.method != "POST":
        ...
        try:
            ...
            staff = Staffs.objects.get(admin=customuser.id)  # type: ignore
