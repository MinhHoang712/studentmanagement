...
class CustomUser(AbstractUser):
    ...
    user_type  = models.CharField(default= 1, choices= user_type_data, max_length=10)  # type: ignore
...
class Subjects(models.Model):
    ...
    course_id = models.ForeignKey(Courses, on_delete=models.CASCADE, default=1)  # type: ignore
...
#Function tự động thêm data của HOD, Staff và Student
def create_user_profile(sender, instance, created, **kwags):
    #Nếu đã insert oke r
    if created: 
        #Check loaik người dùng và thêm data tương ứng
