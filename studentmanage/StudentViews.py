...
from studentmanage.models import CustomUser, Staffs, Courses, Subjects, Students, Attendance, AttendanceReport, LeaveReportStudent, FeedBackStudent, StudentResult
...
def student_profile_update(request):
    if request.method != "POST":
        ...
        try:
            ...
            student = Students.objects.get(admin=customuser.id)  # type: ignore
